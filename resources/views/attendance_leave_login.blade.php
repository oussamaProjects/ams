    ...
    <div class="login-box">
        ...
        @if (\Route::currentRouteName() == 'attendance.login')
            ...
            <div class="login-box-body">
                ...
                <form class="form-horizontal row" id="attendance_leave" method="POST"
                    action="{{ route('attendance.assign') }}">
                @else
                    <div class="image m-b-md">
        ...
        <div class="pin_code">
            <input type="password" class="form-control" name="pin_code" placeholder="input Your Pin Code ( 4 Digits )"
                required>
        ...
        <div class="button">
            <button type="submit" class="btn btn-primary btn-block btn-flat" name="login"><i class="fa fa-sign-in"></i>
                Sign In</button>
        </div>
        </form>
    </div>
